...
<main id="main">
  ...
  <section class="page-hero" aria-labelledby="casos-h1">
    <div class="container">
      ...
      <p class="page-hero-desc">Proyectos anonimizados con el contexto, el problema, el diagnóstico y las acciones tomadas. Casos reales de mi trabajo como <a href="/" style="color:var(--orange);font-weight:600;">consultor SEO en Albacete</a> y toda España. Sin porcentajes inventados ni resultados inflados.</p>
    </div>
  </section>
