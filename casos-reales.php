...
<main id="main">
  ...
  <?php
  $cta = ['title' => '¿Tu caso se parece a alguno de estos?', 'subtitle' => 'Cuéntame qué está pasando con tu web. Identificar bien el problema es el primer paso.', 'btn_label' => 'Hablar sobre mi situación', 'btn_href' => '/contacto.php', 'whatsapp' => true, 'variant' => 'dark'];
