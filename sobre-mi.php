...
<main id="main">
  ...
  <?php
  $cta = ['title' => '¿Quieres trabajar juntos?', 'subtitle' => 'Cuéntame tu proyecto o la situación de tu web. Te respondo con una valoración inicial.', 'btn_label' => 'Enviar mensaje', 'btn_href' => '/contacto.php', 'whatsapp' => true, 'variant' => 'dark'];
