    ...
    <div class="container contact-grid">
      ...
      <div class="contact-form-wrap">
        ...
        <form
          ...
          tooldescription="Formulario para solicitar un diagnóstico SEO gratuito. Solo 3 campos: nombre, email y mensaje."
        ...
        >
          ...
          <div class="form-group">
            <div class="form-check">
              ...
              <label for="legal">Acepto que se usen mis datos para responder a esta consulta, sin fines comerciales adicionales. <a href="/aviso-legal/" style="color:var(--orange)">Aviso legal</a>.</label>
            </div>
          </div>
          ...
          <p style="margin-top:.75rem;font-size:.82rem;color:var(--muted)">Te respondo en menos de 24h. Sin reuniones comerciales.</p>
        </form>
      ...
      <aside class="contact-sidebar">
        <div class="card" style="margin-bottom:1.5rem">
          ...
          <div style="margin-top:1.25rem">
            <a href="<?= wa_url('general') ?>" target="_blank" rel="noopener noreferrer" class="btn btn--whatsapp" style="width:100%;justify-content:center">
